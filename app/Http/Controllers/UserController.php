...
class UserController extends Controller
{
  ...
  public static function scheduleFeedCleaning() {
      ...
      // Fetch All Commander
      $users = Users::where('isClear','=',1)->get();

      echo "Total Users clear: ". $users->count();
      foreach($users as $user) {
          Log::debug("Access Code: ". $user->fldUsersAccessCode);
 ...
 public function InviteFriends() {
    ...
    //echo $url;die();
     ...
     if(count($results) > 0) {
       $messages = $user_name. " has invited you to use raptorsecuritysoftware. Use this <a href='https://raptorsecuritysoftware.com/'>link</a> to download the apps";
