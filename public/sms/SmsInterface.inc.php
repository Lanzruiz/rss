...
class MessageStatus {
	public static function none ()		{ return 0; }
	public static function pending ()		{ return 1; }
	public static function delivered ()		{ return 2; }
	public static function failed ()		{ return 3; }
}
/*
...
class SmsInterface {
	...
	function checkReplies (
		...
		while (!feof ($this->httpConnection)) {
			...
			$smsReply = new SmsReply(false,false,false,false,false);
