...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.2.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('public/assets/css/console.css')}}?<?php echo strtotime(date('Y-m-d h:i:s')) ?>">
    <?php /*<link rel="stylesheet" type="text/css" media="screen" href="{{url('public/assets/css/responsive.css')}}">*/ ?>
    <!-- tuser audio player -->
...
<style type="text/css">
  ...
  body{
    ...
    <?php /*<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyA46DKC6GhBb46BpIj1GMSGtQyfaiX6HIc&libraries=geometry"></script>*/ ?>
	...
	*/ ?>
	...
	<script src="{{url('public/assets/swfobject/swfobject.js')}}"></script>
...
<div class="col-lg-12 footers">
        <footer class="container">
            <h5>&trade; &copy; 2008-<?php echo date("Y");?> RaptorSecuritySoftware, LLC. All Rights Reserved </br>
