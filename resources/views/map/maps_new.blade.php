...
<head>
    ...
    <style>
      .container{
       ...
       #autoZoom { width : 80%; top : 0; left : 0; bottom: 0; right: 0; margin: auto; position : absolute; z-index : 200;}
       #btnZoom {margin-top: 10px;}
    ...
    <body>
        <div class="row">
            <div class="col-md-12">
              <div class="container">
                <div id="autoZoom">
                    <button class="btn btn-danger" id="btnZoom" value="0">Auto Zoom - Off</button>
                </div>
                  @if($error == "")
                    <div id="map"></div>
                  @else
...
<script>
    ...
    function initializeMap() {
      console.log("initializeMap has been called");
      defaultZoomBtn();
      ...
      //   if(zoomFromTransport == true) {
      //      manualZoom = false;
      //   } else {
      //      manualZoom = true;
      //   }
      //   counter = 0;
      //   console.log("101 manualZoom 2 " + manualZoom);
  ...
  function initMap(lat,lon, type,accesscode){
    ...
    //   // if($(this).attr('title') == "Zoom in") {
    //   //    console.log("Zoom in has been click");
    //   // }
    // });
