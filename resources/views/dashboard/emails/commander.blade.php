...
<body>
  ...
  <p>Dear {{$fullname}}</p>
  <p>Thank you for registering your Commander account with {{PRODUCT_TITLE}}</p>
  <p><table><tr><td>Your Username is</td><td>:</td><td>{{$username}}</td></tr>
  <tr><td>Your Password is</td><td>:</td><td>{{$password}}</td></tr></table>
  <br> To login, please click here: <a href='https://raptorsecuritysoftware.com'>{{PRODUCT_TITLE}}</a></p>
  <p>Please keep this information secure, as it is required to access the {{PRODUCT_TITLE}} Command Center.</p>
