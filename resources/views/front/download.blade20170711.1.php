    ...
    <div class="panel-heading">
      <h5 style="text-align:center; font-weight:bold;font-size:14px;">iOS Transport</h5>
          ...
          <div class="col-lg-12">
                ...
                <a id="agentLogo" href="{{url('public/download/ipa/LiveWitnessTrans.ipa')}}" class="thumbnail">
                <img id="agentLogo2" src="{{url('public/assets/images/app_icon/t-deep.png')}}" style="width:128px;" alt="iOS Transport">
            </a>
          </div>
  </div>
  ...
  <div class="panel panel-info">
      <div class="panel-heading">
        <h5 style="text-align:center; font-weight:bold;font-size:14px;">iOS Agent</h5>
            ...
            <div class="col-lg-12">
                  <?php /*<a id="agentLogo" href="{{url('public/download/livewitness.ipa')}}" class="thumbnail">*/ ?>
                  <a id="agentLogo" href="{{url('public/download/ipa/LiveWitnessAgent.ipa')}}" class="thumbnail">
                  <img id="agentLogo2" src="{{url('public/assets/images/app_icon/a-deep.png')}}" style="width:128px;" alt="iOS Agent">
              </a>
            </div>
    </div>
