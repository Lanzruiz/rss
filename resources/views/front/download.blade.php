...
<div class="panel panel-info">
  <div class="panel-heading">
    <h5 style="text-align:center; font-weight:bold;font-size:14px;">Android Transport</h5>
        ...
        <div class="col-lg-12">
          <!--<a href="itms-services://?action=download-manifest&url=https://witnessone.net/Apps/w1_agent/manifest.plist" class="thumbnail">-->
              <a id="agentLogo" href="{{url('public/download/apk/livewitnessapp_trans.apk')}}" class="thumbnail">
         <!-- <img src="images/App_Store_Icon.png" style="width:128px;"  alt="Download Agent" />-->
...
<div class="panel panel-info">
  <div class="panel-heading">
    <h5 style="text-align:center; font-weight:bold;font-size:14px;">Android Agent</h5>
        ...
        <div class="col-lg-12">
          <!--<a href="itms-services://?action=download-manifest&url=https://witnessone.net/Apps/w1_agent/manifest.plist" class="thumbnail">-->
              <a id="agentLogo" href="{{url('public/download/apk/livewitnessapp_agent.apk')}}" class="thumbnail">
         <!-- <img src="images/App_Store_Icon.png" style="width:128px;"  alt="Download Agent" />-->
    ...
    <div class="panel-heading">
      <h5 style="text-align:center; font-weight:bold;font-size:14px;">iOS Transport</h5>
          ...
          <div class="col-lg-12">
                ...
                <a href="itms-services://?action=download-manifest&url={{url('public/download/ipa/RSS/Transportmanifest.plist')}}" class="thumbnail">
                <img id="agentLogo2" src="{{url('public/assets/images/app_icon/lwwt_tansport.jpg')}}" style="width:128px;" alt="RSS Trans">
            </a>
          </div>
  </div>
...
<div class="panel panel-info">
    <div class="panel-heading">
      <h5 style="text-align:center; font-weight:bold;font-size:14px;">iOS Agent</h5>
          ...
          <div class="col-lg-12">
                ...
                <a href="itms-services://?action=download-manifest&url={{url('public/download/ipa/RSS/Agentmanifest.plist')}}" class="thumbnail">
                <img id="agentLogo2" src="{{url('public/assets/images/app_icon/lwwt_agent.jpg')}}" style="width:128px;" alt="RSS Agent">
            </a>
          </div>
  </div>
 ...
 <?php /*
  <div class="panel panel-info">
      <div class="panel-heading">
        <h5 style="text-align:center; font-weight:bold;font-size:14px;">iOS Commander</h5>
      </div>
            <br>
            <div class="col-lg-12">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
          <h5 style="text-align:center; font-weight:bold;font-size:14px;">WeSeeYou</h5>
        </div>
              <br>
              <div class="col-lg-12">
