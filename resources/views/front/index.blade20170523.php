  ...
  <div class="col-lg-4" style='box-shadow: 10px 0px 10px -7px rgba(0,0,0,0.5), -10px 10px 10px -7px rgba(0,0,0,0.5); overflow: auto;'>
      <div style='margin-top:25px;'>
        <fieldset><legend>Login</legend>
         ...
         <div class="form-group">
            <div class="col-lg-12">
            <input type="text" name="username"  value="<?php /*echo $_COOKIE['remember_me'];*/ ?>" placeholder="Email/Username" class="validate[required] form-control">
         ...
         <div class="form-group">
             <div class="col-lg-12">
            <input type="password" name="password" value="<?php /*echo $_COOKIE['remember_ps'];*/ ?>" placeholder="password" class="validate[required] form-control">
